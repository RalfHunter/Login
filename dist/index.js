...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, csvService_1.csvExiste)(fileName);
        ...
        while (true) {
            ...
            if (logar == "s") {
                while (true) {
                    ...
                    switch ((0, csvService_1.retornarUsuarios)(fileName, Email, Senha)) {
